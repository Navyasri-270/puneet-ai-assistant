                    ...
                    >
                      <div className="space-y-1.5 flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {(() => {
                            const rawId = item.id.replace('task-deadline-', '').replace('reminder-', '');
                            const isSyncingThis = Boolean(syncingItemIds[rawId]);

                            if (item.outlookSyncStatus === 'Synced') {
                              return (
                            ...
                            if (item.outlookSyncStatus === 'Failed') {
                              return (
                                <div className="flex items-center gap-1">
                                  ...
                                  <button
                                    ...
                                    onClick={() => handleManualItemSync(item.type === 'event' ? 'event' : item.type === 'reminder' ? 'reminder' : 'task', rawId)}
                                  ...
                                  >
                                    {isSyncingThis ? 'Syncing...' : 'Sync to Outlook'}
                                  </button>
                                </div>
                              );
                            }
